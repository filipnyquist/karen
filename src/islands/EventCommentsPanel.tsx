...
// form on the event detail page. Listens on /ws/event/:eventId for
// server-pushed "comments changed" notifications and refetches when
...
export default function EventCommentsPanel({
    ...
    useEventSocket(eventId, (kind) => {
        if (kind === "comments") fetchComments();
    });
