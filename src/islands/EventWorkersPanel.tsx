...
// detail page. Listens on /ws/event/:eventId for server-pushed
// "workers changed" notifications and refetches the worker list when
// one arrives — no polling.
...
interface Props {
    ...
    /** Event's cap. If set, the heading shows "{n}/{maxWorkers}". */
